 ...
 print' <tr>
    ...
    Pompa1: 
      <form id="form1" name="form1" method="post" action="">
        <input type="submit" name="Pornire" id="1" value="Pornire" onClick="MM_openBrWindow(\'actionare.php?com=1\',\'\',\'width=500,height=100,valign=center \')">
  <input type="submit" name="Oprire" id="2" value="Oprire" onClick="MM_openBrWindow(\'actionare.php?com=2\',\'\',\'width=500,height=100,valign=center \')">
...
<p>Ultima pompa pornita: <font color="red">'.$row['Prenume'].' '.$row['Nume'].'</font> </p>
<p>Data ultimei stropiri: <font color="red">'.$row['Data'].'</font> Ora: <font color="red">'.$row['Ora'].'</font></p>
<p>de cate ori a fost pornita pompa/zi: <font color="red">'.$total.'</font></p>
...
<p><input type="button" text="Automat" onClick="shell_exec('.$aut.')"/>
  ...
  <tr>
    ...
    print '
    <center><a href=gestionare.php?mod=adaugare>Adaugare pompa noua</a></center><br>
	<center><a href=gestionare.php?mod=modificare>Modificare pompa</a></center><br>
	<center><a href=gestionare.php?mod=stergere>Stergere pompelor</a></center><br>';
	}
  print'
  </td>
  </tr>
